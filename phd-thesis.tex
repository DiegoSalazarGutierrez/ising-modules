...
We now describe the universal Virasoro vertex algebra $\Vir^c$, where $c \in \mathbb{C}$.
...
The vertex algebra $\Vir^c$ has a unique maximal ideal, and the quotient $\Vir_c$ is the simple Virasoro vertex algebra.
