...
\begin{proof}\leavevmode
  \begin{enumerate}
  \item This is \Cref{lmm:6} with $H = L_0$.
...
\begin{proof}
  Let $U$ be a subrepresentation of $V$.
  By \Cref{thr:23}, $U^{\perp}$ is a subrepresentation of $V$ and $U\oplus U^{\perp} = V$.
  By \Cref{lmm:7}(ii), either $U = V$ or $U = 0$.
...
But $\langle v| \omega(P)u\rangle = \langle \omega(P)u\rangle$ because all eigenspaces of $L_0$ are pairwise orthogonal by \Cref{thr:23}.
...
By \Cref{thr:41}, this is independent of the choice of the highest weight vector $v$ and there is essentially one form.
By \Cref{clr:3}, a unitary highest weight representation is necessarily irreducible, therefore it is of the form $L(c, h)$ for some real numbers $c, h \in \mathbb{R}$.
