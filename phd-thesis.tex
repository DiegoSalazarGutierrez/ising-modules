...
\begin{proof}\leavevmode
  ...
  \item First, we note that $G^{n - p}M_{h + n} = 0$ for $p, n \in \mathbb{N}$ with $p \ge n$ by \Cref{prp:17}(i).
    By \eqref{eq:44} and \Cref{prp:18},
    \begin{equation*}
  ...
  \item First, we prove $\ch_M(q) = \ch_{\gr_F(M)}(q) = \ch_{\gr_F(M)}(1, q)$.
    ...
    By (i) and $\dim(M_{h + n}) < \infty$ for $n \in \mathbb{N}$, $F_pM_{h + n} = 0$ for $n \in \mathbb{N}$ and $p \in \mathbb{N}$ big enough. This implies $\sigma^M_p(F_pM_{h + n}) = 0$ for $n \in \mathbb{N}$ and $p \in \mathbb{N}$ big enough.
    By \eqref{eq:45} and \Cref{prp:16}(i), for $n \in \mathbb{N}$,
    \begin{align*}
      \dim(\gr_F(M)_{h + n}) &= \sum_{p \in \mathbb{N}}\dim(\sigma^M_p(F_pM_{h + n})) \\
                             &= \sum_{p \in \mathbb{N}}(\dim(F_pM_{h + n}) - \dim(F_pM_{h + n + 1})) \\
                             &= \dim(F_0M_{h + n}) \\
                             &= \dim(M_{h + n}).
    \end{align*}
    ...
    By \Cref{prp:17}(ii)--(iii), $G^pM_{h + n} = M_{h + n}$ for $p, n \in \mathbb{N}$ with $p \ge n$.
...
\begin{example}[$R_{M(c, h)}$ and $R_{L(c, h)}$]
  ...
  By \Cref{prp:18}, \Cref{exa:15} and \Cref{exa:16}, we have the following isomorphism of modules over Poisson algebras
  \begin{align*}
...
\begin{example}[$JR_{\Vir^c} \otimes_{R_{\Vir^c}} R_{M(c, h)}$]
  \label{exa:22}
  We pick a highest weight $(c, h)$.
  The Verma module $M(c, h)$ is always classically free as a $\Vir^c$-module because by \Cref{prp:18}, \Cref{exa:15}, \Cref{exa:16} and \Cref{exa:21},
  \begin{align*}
...
\begin{proof}[Proof of \Cref{thr:4}]
  ...
  Therefore, by \Cref{lmm:33}, isomorphism \eqref{eq:54} and the isomorphism between $\gr^G(L)_{1/2 + n}$ and $L_{1/2 + n}$ of \Cref{prp:20}, we have
  \begin{equation*}
  ...
  This observation, together with the isomorphism between $L$ and $\gr^G(L)$ of \Cref{prp:20}, concludes the proof of \Cref{thr:4}.
\end{proof}
