...
This article is organized as follows: In \Cref{sec:prel-notat}, we review Verma modules, the standard filtration, Gröbner bases and consider Nahm-like sums of two variables.
...
From now on, take $V = \Vir^{1/2}$ (the universal Virasoro vertex algebra of central charge $1/2$) as the $\mathbb{N}$-graded vertex algebra with conformal vector $\omega = L_{-2}\vac$.
