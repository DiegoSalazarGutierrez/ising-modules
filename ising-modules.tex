...
In the appendices, we show the SageMath \cite{sagemath} program used compute a Poisson submodule related to the exceptional partitions appearing in $R$ and briefly explain the case $L(1/2, 1/16)$.
...
If $f: M_1 \to M_2$ is an homomorphism of $h + \mathbb{N}$-graded $(V, \omega)$-modules, then
\begin{align*}
