...
We set $\lm(0)=0$.
% Note that from the definition of our order, if $a\in U(\Vir_{\le -2})$ is such that $\lm(a)=L_\lambda$ then $\lm(\alpha^{\len(a)}(a\vac))=m_\lambda$. ESTO ES NECESARIO? SI, ES EXACTAMENTE LO QUE QUIERO
