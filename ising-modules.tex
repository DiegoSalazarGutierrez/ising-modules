...
\begin{proof}[Proof of \Cref{thr:4}]
  ...
  Therefore, by \Cref{lmm:6}, isomorphism \eqref{eq:7} and the isomorphism between $\gr^G(L)_{1/2 + n}$ and $L_{1/2 + n}$ of \Cref{prp:4}, we have
  \begin{equation*}
  ...
  This observation, together with the isomorphism between $L$ and $\gr^G(L)$ of \Cref{prp:4}, concludes the proof of \Cref{thr:4}.
\end{proof}
