...
\begin{frame}
  ...
  A pair $(a(z), b(z))$ of $\End(V)$-valued formal distributions is \emph{local} if there exists $N \in \mathbb{N}$ such that
  \begin{equation*}
    (z - w)^N[a(z), b(w)] = 0.
  \end{equation*}
\end{frame}
...
\begin{frame}
  ...
  \begin{theorem}[{\cite{dong_twisted_1998}, \cite{zhu_modular_1996}}]
    \label{thr:5}
